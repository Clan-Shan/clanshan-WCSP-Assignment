...
channel_rho = 0; % channel correlation parameter % 0/0.5/1
precoding_method = 1; % 1: codebook-based; 2: SVD 
...
for nn = 1:length(SNR)  % you can use parfor here to accelerate your code
